...
public class SettingsDatabaseConfiguration {
    ...
    entityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("dataSource") DataSource dataSource) {
        return builder
                ...
                .packages("org.unidue.ub.libintel.almaconnector.model.run","org.unidue.ub.libintel.almaconnector.model.bubi", "org.unidue.ub.libintel.almaconnector.model.jobs")
                .build();
    }
