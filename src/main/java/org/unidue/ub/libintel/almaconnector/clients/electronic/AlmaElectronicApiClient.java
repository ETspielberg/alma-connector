package org.unidue.ub.libintel.almaconnector.clients.electronic;
...
import org.unidue.ub.libintel.almaconnector.clients.bib.CatalogFeignConfiguration;

import java.util.List;

@FeignClient(name = "electronic", url = "https://api-eu.hosted.exlibrisgroup.com/almaws/v1/electronic", configuration = CatalogFeignConfiguration.class)
@Service
