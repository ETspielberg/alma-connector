...
public class RegalfinderService {
    ...
    private final List<String> ignoredLocations = Arrays.asList("ENP", "DNP", "EPR", "DPR", "DBB", "EBB", "AFL", "DES", "EES", "DHS", "UNASSIGNED", "FL-AUSL", "FL-LS"," ELS", "ERK", "DRK","EHS", "MPR", "MNP", "MHS", "E08", "E70", "E84", "D07", "D50");
