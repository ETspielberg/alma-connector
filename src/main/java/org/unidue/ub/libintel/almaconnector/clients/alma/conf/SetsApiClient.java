...
public interface SetsApiClient {
    ...
    @RequestMapping(method = RequestMethod.GET,
            ...
            produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    Sets getConfSets(@RequestParam("content_type") String contentType,
                     @RequestParam("set_type") String setType,
                     @RequestParam("q") String q,
                     @RequestParam("limit") Integer limit,
                     @RequestParam("offset") Integer offset,
                     @RequestParam("set_origin") String setOrigin);
     ...
     */
    @RequestMapping(method = RequestMethod.GET,
            value = "/sets/{setId}/members",
            produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    Members getConfSetsSetIdMembers(@PathVariable("setId") String setId,
    ...
    @RequestMapping(method = RequestMethod.POST,
            ...
            produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    Set postConfSets(@RequestBody Set body, @RequestParam("population") String population,
                     @RequestParam("job_instance_id") String jobInstanceId,
                     @RequestParam("from_logical_set") String fromLogicalSet,
                     @RequestParam("combine") String combine,
                     @RequestParam("set1") String set1,
                     @RequestParam("set2") String set2);
    ...
    @RequestMapping(method = RequestMethod.POST,
            ...
            produces = MediaType.APPLICATION_JSON_VALUE,
            consumes = MediaType.APPLICATION_JSON_VALUE)
    Set postConfSetsSetId(@RequestBody Set body,
