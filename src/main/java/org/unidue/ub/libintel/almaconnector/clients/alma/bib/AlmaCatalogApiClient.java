...
@FeignClient(name = "invoices", url = "https://api-eu.hosted.exlibrisgroup.com/almaws/v1/bibs", configuration = AlmaFeignConfiguration.class)
@Service
public interface AlmaCatalogApiClient {
    ...
    void deleteBibsMmsIdHoldingsHoldingIdItemsItemPid(@PathVariable("mmsId") String mmsId,
                                                      ...
                                                      @RequestParam("override") String override,
                                                      @RequestParam("holdings") String holdings);
    ...
    List<Bib> getBibs(@RequestParam("mms_id") String mmsId,
                      ...
                      @RequestParam("representation_id") String representationId,
                      @RequestParam("nz_mms_id") String nzMmsId,
                      @RequestParam("cz_mms_id") String czMmsId,
    ...
    Items getBibsMmsIdHoldingsHoldingIdItems(@PathVariable("mmsId") String mmsId,
                                             ...
                                             @RequestParam("currentLibrary") String currentLibrary,
                                             ...
                                             @RequestParam("modifyDateFrom") String modifyDateFrom,
                                             @RequestParam("modifyDateTo") String modifyDateTo,
                                             @RequestParam("receiveDateFrom") String receiveDateFrom,
                                             @RequestParam("receiveDateTo") String receiveDateTo,
                                             @RequestParam("expectedReceiveDateFrom") String expectedReceiveDateFrom,
                                             @RequestParam("expectedReceiveDateTo") String expectedReceiveDateTo,
                                             @RequestParam("view") String view);
    ...
    Item postBibsMmsIdHoldingsHoldingIdItemsItemPid(@PathVariable("mmsId") String mmsId,
                                                    ...
                                                    @RequestParam("circ_desk") String circDesk,
                                                    @RequestParam("department") String department,
                                                    @RequestParam("work_order_type") String workOrderType,
                                                    @RequestParam("status") String status,
                                                    @RequestParam("external_id") String externalId,
                                                    @RequestParam("done") String done,
                                                    @RequestParam("auto_print_slip") String autoPrintSlip,
                                                    @RequestParam("place_on_hold_shelf") String placeOnHoldShelf,
                                                    @RequestParam("confirm") String confirm,
                                                    @RequestParam("register_in_house_use") String registerInHouseUse);
    ...
    Bib putBibsMmsId(@RequestBody Object body,
                     ...
                     @RequestParam("normalization") String normalization,
                     @RequestParam("validate") String validate,
                     @RequestParam("overrideWarning") String overrideWarning,
                     @RequestParam("overrideLock") String overrideLock,
                     @RequestParam("staleVersionCheck") String staleVersionCheck,
                     @RequestParam("catalogerLevel") String catalogerLevel,
                     @RequestParam("checkMatch") String checkMatch);
