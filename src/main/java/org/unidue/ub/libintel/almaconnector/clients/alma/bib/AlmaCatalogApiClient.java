...
public interface AlmaCatalogApiClient {
  ...
  Items getBibsMmsIdHoldingsHoldingIdItems(@RequestParam("mmsId") String mmsId, @RequestParam("holdingId") String holdingId, @RequestParam("limit") Integer limit, @RequestParam("offset") Integer offset, @RequestParam("expand") String expand, @RequestParam("userId") String userId, @RequestParam("currentLibrary") String currentLibrary, @RequestParam("currentLocation") String currentLocation, @RequestParam("q") String q, @RequestParam("orderBy") String orderBy, @RequestParam("direction") String direction, @RequestParam("createDateFrom") String createDateFrom, @RequestParam("createDateTo") String createDateTo, @RequestParam("modifyDateFrom") String modifyDateFrom, @RequestParam("modifyDateTo") String modifyDateTo, @RequestParam("receiveDateFrom") String receiveDateFrom, @RequestParam("receiveDateTo") String receiveDateTo, @RequestParam("expectedReceiveDateFrom") String expectedReceiveDateFrom, @RequestParam("expectedReceiveDateTo") String expectedReceiveDateTo, @RequestParam ("view") String view);
